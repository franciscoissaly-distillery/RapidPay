...
namespace RapidPay.Cards.Data.Mocks
{
    public class CardsInMemoryRepository : CardsRepositoryBase

    {
        public CardsInMemoryRepository(DefaultEntities defaultEntities)
